/* github.com/wuqb2i4f/xray-config-toolkit - v1.6.0（20250215） */
...
async function handleRequest(request) {
  ...
  const handlerMapping = {
    ...
    'uriExtra': (proxy) => () => handleUriExtraType(proxy.data),
...
async function handleUriExtraType(list) {
  const uriList = [];
